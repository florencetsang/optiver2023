...
lgb_model = joblib.load('ensemble_models/lgb_learning_rate_0.018123180072548012_max_depth_12_n_estimators_700')
...
mlp_model = keras.models.load_model('ensemble_models/mlp_None_20240423_mlp_moving_avg.keras')
